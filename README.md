...
Sistema de información para **GameZone Unicesar**, una tienda de videojuegos y consolas ubicada en el sector universitario de Valledupar. El sistema permite gestionar productos (videojuegos y consolas), personas (clientes y vendedores) y ventas, con persistencia de la información entre ejecuciones.
